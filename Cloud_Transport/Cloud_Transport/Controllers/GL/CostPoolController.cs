...
namespace Cloud_Transport.Controllers
{
    public class CostPoolController : AppController
    {
        ...
        public ActionResult IndexPost(PageModel model, string command)
        {
            ...
            if (command == "Add")
            {
                ...
                try
                {
                    ...
                    if (mst_CompID == null && mst_CostCID == null)
                    {
                        ...
                        model.AGlCostPool.BUYDT = null;
                        model.AGlCostPool.REGDT = null;
                        return View("Index");
                    }
                    else
                    {
            ...
            if (command == "Update")
            {
                ...
                foreach (GL_COSTPOOL a in query)
                {
                    ...
                    a.BUYDT = Convert.ToDateTime(model.BuyDate);
                    a.REGDT = Convert.ToDateTime(model.RegDate);
                ...
                model.AGlCostPool.REGDT = null;
                model.AGlCostPool.REMARKS = "";
                TempData["Buy_Reg_Date"] = null;


                return RedirectToAction("Index");

            }
            if (command == "Update Vehicle Type")
            {
        ...
        public ActionResult EditAccountUpdate(Int64 id, Int64 cid, Int64 Costcid, Int64 costPId, string costPName,string buyDate, string regDate, PageModel model)
        {
            //.........................................................Create Permission Check
            var LoggedCompId = System.Web.HttpContext.Current.Session["loggedCompID"].ToString();
            var loggedUserID = System.Web.HttpContext.Current.Session["loggedUserID"].ToString();
            ...
            TempData["Buy_Reg_Date"] = "BuyDate and RegDate";
