...
namespace Cloud_Transport.Controllers.GL
{
    public class TransactionController : AppController
    {
        ...
        public JsonResult Update_SelectTransNo(Int64 changedtxt,string type)
        {
            ...
            var selectdata = from n in db.GlStransDbSet where n.COMPID == compid && n.TRANSNO == changedtxt && n.TRANSTP == type select new { n.Gl_StransID, n.TRANSDT, n.TRANSTP, n.TRANSFOR, n.TRANSMY, n.COSTPID,n.TRIPNO, n.TRANSMODE, n.DEBITCD, n.CREDITCD, n.REMARKS, n.AMOUNT, n.CHEQUEDT, n.CHEQUENO };
            string transfor = "", transmode = "", chequeno = "", chequedate = "", remarks = "", debitaccount = "", creditaccount="";
          
            Int64 costpoolid = 0,tripno=0, debitcd = 0, creditcd = 0,amount=0,primaryid=0;
            ...
            foreach (var l in selectdata)
            {
                ...
                tripno = Convert.ToInt64(l.TRIPNO);
            ...
            var result = new { keyid = primaryid, For = transfor, date = chequedate, costpool = costpoolid, TripNo = tripno, mode = transmode,firstdebittext=debitaccount,debitCD=debitcd, debit = Debitlist,firstcredittext=creditaccount,creditCD=creditcd, credit = Creditlist, cheque = chequeno,ChequeDate=chequedate, remarks = remarks, amount = amount };
