                ...
                else
                {
                    ...
                    if (maxData == 0)
                    {
                        ...
                        if (asluserco.EMAILID != null)
                        {
                            ...
                            mailCompany.From = new MailAddress("admin@trip.karatowatc.com.bd");
                            mailCompany.Subject = "Mail Confirmation";
                            mailCompany.Body = "Alchemy Transport Managemnet System.\n\n" + Environment.NewLine + "Hi, " + asluserco.USERNM + Environment.NewLine
                            ...
                            clientComapny.Host = "mail.karatowatc.com.bd";
                            clientComapny.Credentials = new NetworkCredential("admin@trip.karatowatc.com.bd", "Admin@&trip123%");
                    ...
                    if (asluserco.EMAILID!=null)
                    {
                        ...
                        mail.Body = "Alchemy Transport Managemnet System.\n\n" + Environment.NewLine + "Hi, " + asluserco.USERNM + Environment.NewLine
